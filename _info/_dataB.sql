...
-- -----------------------------------------------------
-- procedure repVentasCajero
-- -----------------------------------------------------

DELIMITER $$
USE `dbChurchill`$$
CREATE PROCEDURE repVentasCajero( _deFecha DATE, _paraFecha DATE )
BEGIN
	SELECT
		f.idFactura,
		f.fechaFactura,
...
-- -----------------------------------------------------
-- procedure repVentasGeneral
-- -----------------------------------------------------

DELIMITER $$
USE `dbChurchill`$$
CREATE PROCEDURE repVentasGeneral( _deFecha DATE, _paraFecha DATE, _tipoReporte VARCHAR(25) )
...
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`usuario` (`usuario`, `idEstadoUsuario`, `idPerfil`, `idDestinoMenu`, `codigo`, `clave`, `nombres`, `apellidos`, `usuarioRegistro`, `fechaRegistro`) VALUES ('polloAdmin', 1, 1, 1, 100, 'P0lloChurchill', 'Usuario', 'Administrador', NULL, '2017-01-01 23:59:59');
...
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`tipoProducto` VALUES (1,'Vegetales'),(2,'Bebidas'),(3,'Embutidos'),(4,'Extra'),(5,'Materia Principal'),(6,'Condimento'),(7,'Empaque');
COMMIT;
...
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`medida` VALUES (1,'Unidad'),(2,'Docena'),(3,'Onza'),(4,'Gramos'),(5,'Galón'),(6,'Libras'),(7,'Mililitro'),(8,'Kilogramos'),(9,'Manojo');
COMMIT;
...
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `producto` VALUES (1,'Tomate',1,3,1,100.00,200.00,15.00,0,'restaurante','2018-05-17 15:08:50',1),(2,'Pollo Fresco',5,1,1,175.00,500.00,100.00,1,'restaurante','2018-05-23 09:55:01',1),(3,'1/2 Botella Black Label',2,3,0,375.00,750.00,3.00,1,'restaurante','2018-05-30 15:32:22',2),(4,'1/2 Botella Red Label',2,3,0,750.00,1500.00,1.00,1,'restaurante','2018-05-30 15:33:39',2),(5,'Agua gaseosa 12 onzas',2,1,0,96.00,300.00,96.00,1,'restaurante','2018-06-04 15:32:22',1),(6,'Agua gaseosa en lata',2,1,0,48.00,144.00,48.00,1,'restaurante','2018-06-04 15:34:54',1),(7,'Agua gaseosa dietetica',2,1,0,1.00,5.00,1.00,0,'restaurante','2018-06-04 16:00:35',1),(8,'Agua pura taparosca',2,1,0,5.00,24.00,12.00,1,'restaurante','2018-06-04 16:01:53',1),(9,'California sabores',2,1,0,5.00,24.00,12.00,1,'restaurante','2018-06-04 16:04:25',1),(10,'Cafe americano',2,4,1,500.00,4000.00,20.00,1,'restaurante','2018-06-04 16:09:08',1),(11,'Nescafe capuccino original',2,4,0,500.00,5000.00,1000.00,1,'restaurante','2018-06-04 16:26:40',1),(12,'Pajillas simples',7,1,0,25.00,200.00,50.00,1,'restaurante','2018-06-04 16:30:12',1),(13,'Pajilla empacada con resorte',7,1,0,500.00,3000.00,1000.00,1,'restaurante','2018-06-04 16:31:31',1),(14,'Vigoteras servilletas',7,1,0,100.00,1000.00,300.00,1,'restaurante','2018-06-04 16:33:57',1),(15,'Lechuga',1,1,0,1.00,10.00,2.00,1,'restaurante','2018-06-04 16:39:20',1),(16,'Papa en gajos',4,3,1,480.00,6000.00,1000.00,1,'restaurante','2018-06-04 16:42:18',1),(17,'Tortillas',5,1,1,20.00,100.00,40.00,1,'restaurante','2018-06-04 16:44:58',1),(18,'Salsa dulce galon',4,5,0,5.00,300.00,50.00,0,'restaurante','2018-06-04 16:48:35',1),(19,'Salsa picante galon',4,5,0,3.00,60.00,30.00,1,'restaurante','2018-06-04 16:49:52',1),(20,'Sal comun',4,3,1,16.00,80.00,32.00,1,'restaurante','2018-06-04 16:53:09',1),(21,'Marinador batter alitas',6,3,0,200.00,880.00,500.00,1,'restaurante','2018-06-04 16:55:02',1),(22,'Queso mozzarella',4,3,1,64.00,200.00,100.00,1,'restaurante','2018-06-04 17:01:56',1),(23,'Helado',4,5,1,1.00,10.00,1.00,1,'restaurante','2018-06-06 12:14:31',1),(24,'Limones',1,1,0,15.00,100.00,25.00,1,'restaurante','2018-06-06 12:18:44',1),(25,'Jugo de naranja de la granja',2,5,0,3.00,24.00,12.00,1,'restaurante','2018-06-06 12:20:23',1),(26,'Pollo mollejas',5,3,1,64.00,512.00,128.00,1,'restaurante','2018-06-06 12:34:02',1),(27,'Sal refinada',4,3,0,16.00,96.00,48.00,1,'restaurante','2018-06-06 12:35:08',1),(28,'Apio',1,1,0,1.00,5.00,2.00,0,'restaurante','2018-06-06 12:36:56',1),(29,'Azucar en bolsita C/1000',7,1,0,500.00,2000.00,1000.00,1,'restaurante','2018-06-06 12:39:34',1),(30,'Palito removedor',7,1,0,100.00,1000.00,200.00,1,'restaurante','2018-06-06 12:41:44',1),(31,'Tapaderas nestle 8 oz',7,1,0,25.00,500.00,100.00,1,'restaurante','2018-06-06 12:43:12',1),(32,'Vasos nestle 8 oz',7,1,0,25.00,500.00,100.00,1,'restaurante','2018-06-06 12:45:41',1),(33,'Leche entera instantanea',2,3,0,80.00,880.00,600.00,1,'restaurante','2018-06-06 12:48:44',1),(34,'Pan hamburguesa',5,1,1,8.00,120.00,16.00,1,'restaurante','2018-06-06 12:50:27',1),(35,'Salchichas pequeñas Rey P/54',3,1,1,20.00,216.00,100.00,1,'restaurante','2018-06-06 12:59:50',1),(36,'Queso IMIT americano 10.67 oz =16 rodajas',3,1,1,16.00,256.00,100.00,1,'restaurante','2018-06-06 13:01:56',1),(37,'Torta de res condimentada 4 oz.',3,1,1,50.00,160.00,100.00,1,'restaurante','2018-06-06 13:05:13',1),(38,'Papa importada B/5.5 lbs.',5,6,1,22.00,264.00,50.00,1,'restaurante','2018-06-06 15:07:34',1),(39,'Palillos',7,1,0,500.00,5000.00,1000.00,1,'restaurante','2018-06-06 15:10:21',1),(40,'Cebolla',1,3,0,16.00,160.00,5.00,1,'restaurante','2018-06-06 15:11:16',1),(41,'Escarola',1,1,0,1.00,10.00,3.00,1,'restaurante','2018-06-06 15:13:44',1),(42,'Cerveza corona botella C/24',2,1,0,12.00,48.00,24.00,1,'restaurante','2018-06-06 15:23:42',1),(43,'Cerveza gallo botella pequeña c/24',2,1,0,12.00,96.00,40.00,1,'restaurante','2018-06-06 15:26:25',1),(44,'Cerveza gallo litro c/24',2,1,0,10.00,50.00,24.00,1,'restaurante','2018-06-06 15:28:04',1),(45,'Cerveza heineken',2,1,0,6.00,30.00,15.00,1,'restaurante','2018-06-06 15:30:49',1),(46,'Cerveza monte carlo c/24',2,1,0,6.00,96.00,15.00,1,'restaurante','2018-06-06 15:34:15',1),(47,'Chocolate',2,6,0,1.00,4.00,12.00,1,'restaurante','2018-06-06 15:37:14',1),(48,'Fosforos c/50',4,1,0,50.00,500.00,200.00,1,'restaurante','2018-06-06 15:42:11',1),(49,'Carne puyazo importado',4,6,1,5.00,35.00,15.00,1,'restaurante','2018-06-06 15:45:05',1),(50,'Elote',1,1,0,2.00,6.00,4.00,1,'restaurante','2018-06-06 15:46:15',1),(51,'Cebollines',4,1,1,3.00,20.00,3.00,0,'restaurante','2018-06-11 14:21:17',1),(52,'Pan sándwich mediano',4,1,1,6.00,30.00,10.00,0,'restaurante','2018-06-11 14:25:20',1),(53,'Longaniza',3,1,1,1.00,120.00,2.00,0,'restaurante','2018-06-11 14:39:58',1),(54,'Chile pimiento',1,1,0,3.00,24.00,12.00,1,'restaurante','2018-06-11 14:43:12',1),(55,'Condimentos para pollo',6,3,0,100.00,1760.00,500.00,1,'restaurante','2018-06-11 14:45:16',1),(56,'Bolsa de gabacha',7,1,0,25.00,500.00,100.00,1,'restaurante','2018-06-11 15:50:25',1),(57,'Salsa dulce empacada 10mg.',7,1,0,500.00,4000.00,2000.00,1,'restaurante','2018-06-11 15:56:53',1),(58,'Bol.Papas/Impresas 9*11 peq P/500',7,1,0,3000.00,30000.00,9000.00,1,'restaurante','2018-06-11 16:04:13',1),(59,'Pie de queso Suministros',4,1,1,20.00,200.00,60.00,1,'restaurante','2018-06-11 16:06:18',1),(60,'Salsa para pizza',4,3,1,170.00,850.00,300.00,1,'restaurante','2018-06-11 16:15:46',1),(61,'Peperoni caja de 10 lbs.',3,6,1,1.00,20.00,5.00,1,'restaurante','2018-06-11 16:17:16',1),(62,'Litro y medio ó 1.75 de agua gaseosa',2,1,0,6.00,80.00,20.00,1,'restaurante','2018-06-11 16:20:12',1),(63,'Harina suave',4,6,0,50.00,500.00,100.00,1,'restaurante','2018-06-11 16:23:58',1),(64,'Huevo u c/30',4,1,0,10.00,60.00,15.00,1,'restaurante','2018-06-11 16:25:07',1),(65,'Margarina',4,3,0,8.00,64.00,16.00,1,'restaurante','2018-06-11 16:27:29',1),(66,'Manga on top de vainilla 1 libra',4,3,1,16.00,100.00,64.00,1,'restaurante','2018-06-12 15:54:06',1),(67,'Aceite botella',5,7,0,500.00,2000.00,1000.00,1,'restaurante','2018-06-19 15:53:43',1),(68,'Aceite de oliva',4,7,0,200.00,1000.00,300.00,1,'restaurante','2018-06-19 15:54:27',1),(69,'Aceite para fritura de alta densidad',5,8,0,48.00,190.00,190.00,1,'restaurante','2018-06-19 16:05:06',1),(70,'Aceituna negra rodajada',4,3,1,4.00,25.00,5.00,0,'restaurante','2018-06-19 16:07:53',1),(71,'Aderezo para papas',5,3,0,80.00,400.00,160.00,1,'restaurante','2018-06-19 16:16:32',1),(72,'Aguacate',4,1,1,2.00,5.00,3.00,0,'restaurante','2018-06-20 15:03:47',1),(73,'Ajo',4,3,0,5.00,10.00,7.00,1,'restaurante','2018-06-20 15:04:55',1),(74,'Ajo molido',6,3,0,2.00,16.00,8.00,1,'restaurante','2018-06-20 15:06:24',1),(75,'Ajo redecilla',4,1,0,1.00,6.00,3.00,1,'restaurante','2018-06-20 15:07:24',1),(76,'Ajonjolin',6,3,0,2.00,16.00,8.00,0,'restaurante','2018-06-20 15:08:25',1),(77,'Albahaca molida',6,3,0,8.00,32.00,16.00,0,'restaurante','2018-06-20 15:10:29',1),(78,'Albahaca manojo',6,9,0,1.00,2.00,1.00,0,'restaurante','2018-06-20 15:19:52',1),(79,'Apio',4,9,0,1.00,5.00,2.00,1,'restaurante','2018-06-20 15:21:01',1),(80,'Arberja',4,6,1,1.00,3.00,2.00,0,'restaurante','2018-06-20 15:22:16',1),(81,'Arroz',4,6,0,1.00,10.00,2.00,0,'restaurante','2018-06-26 10:26:48',1),(82,'Avena',4,1,1,1.00,10.00,1.00,0,'restaurante','2018-06-26 10:43:05',1),(83,'Axion L/P. 500G.',4,1,1,1.00,20.00,3.00,1,'restaurante','2018-06-26 10:46:19',1),(84,'Azucar Comun',4,6,1,3.00,50.00,10.00,0,'restaurante','2018-06-26 10:48:38',1),(85,'Azucar Dietetica',4,1,0,50.00,1000.00,300.00,0,'restaurante','2018-06-26 10:56:27',1),(86,'Azucar en sobrecito (Lechoso) Aa. Sisi',4,1,1,1.00,20.00,2.00,0,'restaurante','2018-06-26 10:59:00',1),(87,'Bananos',4,1,0,4.00,48.00,5.00,0,'restaurante','2018-06-26 11:00:47',1),(88,'Bandeja Desechable Para Banana Edeca',7,1,1,10.00,500.00,125.00,0,'restaurante','2018-06-26 11:01:51',1),(89,'Blue Nun Blanco 0.750',2,1,0,1.00,100.00,20.00,0,'restaurante','2018-06-26 11:08:09',1),(90,'Bol. Papas/Imp 12*11 G P/500',7,1,1,3000.00,30000.00,8000.00,1,'restaurante','2018-06-26 11:15:47',1),(91,'Bolovan',4,1,0,1.00,10.00,1.00,0,'restaurante','2018-06-26 11:17:51',1),(92,'Bolsa #4 Craft',7,1,1,100.00,10000.00,200.00,0,'restaurante','2018-06-26 11:19:09',1),(93,'Bolsa 1 Pieza C/papas P/100',7,1,1,100.00,10000.00,1000.00,0,'restaurante','2018-06-26 11:23:43',1),(94,'Bolsa Para Basura Rollo 30 U',7,1,1,60.00,10000.00,500.00,0,'restaurante','2018-06-26 11:25:02',1),(95,'Bolsa Plas. 3*8 F=70000 P=500',7,1,1,500.00,50000.00,10000.00,0,'restaurante','2018-06-26 11:27:22',1),(96,'Bolsa Trasparente 3*8 Real Plastic',7,1,1,100.00,10000.00,400.00,0,'restaurante','2018-06-26 11:28:17',1),(97,'Bolsas De Papel Blancas No.1',7,1,1,100.00,5000.00,400.00,0,'restaurante','2018-06-26 11:51:33',1),(98,'Brazo De Gitano',4,1,0,1.00,50.00,1.00,0,'restaurante','2018-06-26 11:52:10',1),(99,'Brocoli',1,1,0,10.00,200.00,20.00,0,'restaurante','2018-06-26 11:53:05',1),(100,'Cachitos Rellenos de Jamon',4,1,0,1.00,100.00,1.00,0,'restaurante','2018-06-26 11:54:38',1);
COMMIT;

START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `reajuste` VALUES (1,'Compra y proceso de pollo','2018-05-23 09:56:41','restaurante');
COMMIT;

START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `reajusteProducto` VALUES (1,1,2,40.00,1);
COMMIT;


START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `menu` VALUES (1,'pieza de pollo',NULL,'xxxxxxxxxxxxxxxxxxxxx',1,1,0,1,9,6,1),(2,'Menú Churchill',NULL,'cccccccccccc',1,1,7,1,102,7,1);
COMMIT;

START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `receta` VALUES (1,1,1.00,'tostado');
COMMIT;

START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `menuPrecio` VALUES (1,1,9.50),(1,2,10.75),(1,3,9.50),(2,1,25.00),(2,2,35.00),(2,3,25.00);
COMMIT;
