	...
	ELSEIF _action = 'insert' THEN
		...
		IF !ISNULL( _numeroTicket ) THEN
			SELECT TRUE INTO _tktPendiente FROM ordenCliente 
				WHERE numeroTicket = _numeroTicket AND ( idEstadoOrden BETWEEN 1 AND 4 ) AND numMenu > 0
			LIMIT 1;
		END IF;
...
-- -----------------------------------------------------
-- Data for table `dbChurchill`.`menu`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`menu` (`idMenu`, `menu`, `imagen`, `descripcion`, `idEstadoMenu`, `idDestinoMenu`, `top`, `idTipoMenu`, `codigo`, `tiempoAlerta`, `seCocina`) VALUES (1, 'Papas Fritas', 'img-menu/papas.png', 'Papas fritas', 1, 1, 0, 1, 11, 5, 1);
INSERT INTO `dbChurchill`.`menu` (`idMenu`, `menu`, `imagen`, `descripcion`, `idEstadoMenu`, `idDestinoMenu`, `top`, `idTipoMenu`, `codigo`, `tiempoAlerta`, `seCocina`) VALUES (2, 'Café', 'img-menu/cafe.png', 'Café Normal', 1, 2, 0, 2, 33, 5, 1);
INSERT INTO `dbChurchill`.`menu` (`idMenu`, `menu`, `imagen`, `descripcion`, `idEstadoMenu`, `idDestinoMenu`, `top`, `idTipoMenu`, `codigo`, `tiempoAlerta`, `seCocina`) VALUES (3, 'Pollo Especial', 'img-menu/pollo.png', 'Pollo pechuga', 1, 1, 0, 1, 101, 10, 1);
INSERT INTO `dbChurchill`.`menu` (`idMenu`, `menu`, `imagen`, `descripcion`, `idEstadoMenu`, `idDestinoMenu`, `top`, `idTipoMenu`, `codigo`, `tiempoAlerta`, `seCocina`) VALUES (4, 'Pollo Normal', 'img-menu/pollo.png', 'Pollo Cuadril, Pierna, Ala', 1, 1, 0, 1, 102, 10, 1);
...
-- -----------------------------------------------------
-- Data for table `dbChurchill`.`producto`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`producto` (`idProducto`, `producto`, `idTipoProducto`, `idMedida`, `perecedero`, `cantidadMinima`, `cantidadMaxima`, `disponibilidad`, `importante`, `usuario`, `fechaRegistro`, `idUbicacion`) VALUES (1, 'Papas', 1, 3, 0, 50, 200, 70, 1, 'restaurante', '2017-07-11 00:00:00', 1);
INSERT INTO `dbChurchill`.`producto` (`idProducto`, `producto`, `idTipoProducto`, `idMedida`, `perecedero`, `cantidadMinima`, `cantidadMaxima`, `disponibilidad`, `importante`, `usuario`, `fechaRegistro`, `idUbicacion`) VALUES (2, 'Rostizador', 6, 3, 0, 20, 100, 30, 1, 'restaurante', '2017-07-11 00:00:00', 1);
INSERT INTO `dbChurchill`.`producto` (`idProducto`, `producto`, `idTipoProducto`, `idMedida`, `perecedero`, `cantidadMinima`, `cantidadMaxima`, `disponibilidad`, `importante`, `usuario`, `fechaRegistro`, `idUbicacion`) VALUES (3, 'Pollo Pechuga', 5, 1, 0, 100, 300, 20, 1, 'restaurante', '2017-07-11 00:00:00', 1);
INSERT INTO `dbChurchill`.`producto` (`idProducto`, `producto`, `idTipoProducto`, `idMedida`, `perecedero`, `cantidadMinima`, `cantidadMaxima`, `disponibilidad`, `importante`, `usuario`, `fechaRegistro`, `idUbicacion`) VALUES (4, 'Pollo Normal', 5, 1, 0, 100, 300, 20, 1, 'restaurante', '2017-07-11 00:00:00', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `dbChurchill`.`combo`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`combo` (`idCombo`, `combo`, `imagen`, `descripcion`, `idEstadoMenu`, `top`, `codigo`) VALUES (1, 'Combo Familiar', NULL, 'Pollo y papitas', 1, 0, 50);

COMMIT;


-- -----------------------------------------------------
-- Data for table `dbChurchill`.`comboDetalle`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`comboDetalle` (`idCombo`, `idMenu`, `cantidad`) VALUES (1, 1, 3);
INSERT INTO `dbChurchill`.`comboDetalle` (`idCombo`, `idMenu`, `cantidad`) VALUES (1, 3, 2);
INSERT INTO `dbChurchill`.`comboDetalle` (`idCombo`, `idMenu`, `cantidad`) VALUES (1, 4, 3);

COMMIT;


-- -----------------------------------------------------
-- Data for table `dbChurchill`.`receta`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`receta` (`idMenu`, `idProducto`, `cantidad`, `observacion`) VALUES (1, 1, 2, '');
INSERT INTO `dbChurchill`.`receta` (`idMenu`, `idProducto`, `cantidad`, `observacion`) VALUES (3, 3, 1, '');
INSERT INTO `dbChurchill`.`receta` (`idMenu`, `idProducto`, `cantidad`, `observacion`) VALUES (3, 2, 0.5, '');
INSERT INTO `dbChurchill`.`receta` (`idMenu`, `idProducto`, `cantidad`, `observacion`) VALUES (4, 4, 1, '');
INSERT INTO `dbChurchill`.`receta` (`idMenu`, `idProducto`, `cantidad`, `observacion`) VALUES (4, 2, 0.5, '');
...
-- -----------------------------------------------------
-- Data for table `dbChurchill`.`menuPrecio`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (1, 1, 8);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (1, 2, 10);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (1, 3, 8);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (2, 1, 9);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (2, 2, 11);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (2, 3, 9.5);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (3, 1, 8);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (3, 2, 9);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (3, 3, 10);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (4, 1, 7);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (4, 2, 7.5);
INSERT INTO `dbChurchill`.`menuPrecio` (`idMenu`, `idTipoServicio`, `precio`) VALUES (4, 3, 8);

COMMIT;


-- -----------------------------------------------------
-- Data for table `dbChurchill`.`comboPrecio`
-- -----------------------------------------------------
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`comboPrecio` (`idCombo`, `idTipoServicio`, `precio`) VALUES (1, 1, 22);
INSERT INTO `dbChurchill`.`comboPrecio` (`idCombo`, `idTipoServicio`, `precio`) VALUES (1, 2, 20);
INSERT INTO `dbChurchill`.`comboPrecio` (`idCombo`, `idTipoServicio`, `precio`) VALUES (1, 3, 21);
...
START TRANSACTION;
USE `dbChurchill`;
INSERT INTO `dbChurchill`.`parametro` (`idParametro`, `parametro`, `valor`) VALUES ('gruposCocina', 'Grupos de Cocina', '3');
