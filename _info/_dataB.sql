...
CREATE TABLE IF NOT EXISTS `dbchurchill`.`factura` (
  ...
  INDEX `fk_factura_ordenCliente1_idx` (`idOrdenCliente` ASC),
  ...
  CONSTRAINT `fk_factura_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_factura_ordenCliente1`
    FOREIGN KEY (`idOrdenCliente`)
    REFERENCES `dbchurchill`.`ordenCliente` (`idOrdenCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `dbchurchill`;
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (1, 1, 1, 'NIT', 'nit', 15, 20, 1, 0, 13, 2);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (2, 1, 1, 'Nombre', 'nombre', 15, 35, 1, 0, 12, 3);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (3, 1, 1, 'Dirección', 'direccion', 15, 50, 1, 0, 12, 4);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (4, 1, 2, 'Detalle Factura', 'lstDetalle', 15, 75, 0, 0, 12, 5);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (5, 2, 1, 'NIT', 'nit', 15, 20, 1, 0, 13, 2);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (6, 2, 1, 'Nombre', 'nombre', 15, 35, 1, 0, 12, 3);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (7, 2, 1, 'Dirección', 'direccion', 15, 50, 1, 0, 12, 4);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (8, 2, 2, 'Detalle Factura', 'lstDetalle', 15, 75, 0, 0, 12, 5);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (9, 1, 1, 'Fecha', 'fecha', 200, 20, 1, 0, 13, 1);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (10, 1, 1, 'Total Letra', 'totalLetra', 15, 220, 0, 0, 9, 6);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (11, 1, 1, 'Total', 'total', 201, 240, 1, 0, 12, 7);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (12, 2, 1, 'Fecha', 'fecha', 250, 20, 1, 0, 13, 1);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (13, 2, 1, 'Total Letra', 'totalLetra', 15, 220, 0, 0, 11, 6);
INSERT INTO `dbchurchill`.`documentoDetalle` (`idDocumentoDetalle`, `idDocumento`, `idTipoItem`, `label`, `_index`, `x`, `y`, `mostrarTitulo`, `relativo`, `fontSize`, `orden`) VALUES (14, 2, 1, 'Total', 'total', 250, 240, 1, 0, 12, 7);
